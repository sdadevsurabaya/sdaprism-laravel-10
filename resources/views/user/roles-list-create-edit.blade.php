                ...
                <div class="d-block d-lg-none">
                    ...
                    <div id="mobile-role-card-container" class="d-flex flex-column gap-3">
                        @forelse ($data as $item)
                            <div class="card prism-mobile-card border-0 shadow-sm rounded-3 role-item-card">
                    ...
                    <div class="prism-fab-container d-lg-none">
                        <button type="button" class="prism-fab-btn" data-bs-toggle="modal" data-bs-target="#modalCreateRoles" aria-label="Add Role">
