                ...
                <div class="d-block d-lg-none">
                    ...
                    <div id="mobile-currency-card-container" class="d-flex flex-column gap-3">
                        @forelse ($data as $item)
                            <div class="card prism-mobile-card border-0 shadow-sm rounded-3 currency-item-card">
                    ...
                    <div id="mobile-currency-pagination-wrapper" class="d-flex flex-column align-items-center gap-2 mt-4">
                        ...
                        <nav>
                            <ul id="mobile-currency-pagination-nav" class="pagination pagination-sm mb-0 flex-wrap justify-content-center"></ul>
                        </nav>
                    </div>

                    <div class="prism-fab-container d-lg-none">
                        <button type="button" class="prism-fab-btn" data-bs-toggle="modal" data-bs-target="#modalCreateCurrency" aria-label="Add Currency">
