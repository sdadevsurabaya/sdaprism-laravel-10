 ...
 <div class="modal fade" id="kt_modal_add_Onepoint_uniquecode" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">  
      <div class="modal-content">    
        <div class="modal-header" id="kt_modal_add_Onepoint_uniquecode_header">      
          <h2 class="fw-bold">ADD ONEPOINT UNIQUECODE</h2>            
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">      
          {!! Form::open(array("route" => "onepoint_uniquecode.store","method"=>"POST","enctype"=>"multipart/form-data")) !!}                     
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_Onepoint_uniquecode_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_Onepoint_uniquecode_header" data-kt-scroll-wrappers="#kt_modal_add_Onepoint_uniquecode_scroll" data-kt-scroll-offset="300px">                                                   
              <div class="fv-row mb-7">
                  <label class=" fw-semibold fs-6 mb-2">KODE</label>
                  {!! Form::text("kode", null, array("placeholder" => "KODE","class" => "form-control form-control-solid mb-3 mb-lg-0")) !!}
              </div>              
                <div class="fv-row mb-7">
                  <label class=" fw-semibold fs-6 mb-2">POINT</label>
                  {!! Form::text("point", null, array("placeholder" => "POINT","class" => "form-control form-control-solid mb-3 mb-lg-0")) !!}
              </div>              
                <div class="fv-row mb-7">
                ...
                <div class="fv-row mb-7">
                  ...
                  {!! Form::text("deleted", null, array("placeholder" => "DELETED","class" => "form-control form-control-solid mb-3 mb-lg-0")) !!}
              </div>
            </div>                
  ...
  <!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++end::Modal - add Onepoint_uniquecode-->
