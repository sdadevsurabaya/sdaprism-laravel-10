                    ...
                    <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                {!! Form::model($promoCollection, [
                                    'route' => ['onepoint_menu_promo.update', $promoCollection->id],
                                    'method' => 'PUT',
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="promo_collection_name"
                                            value="{{ old('promo_collection_name', $promoCollection->name ?? '') }}"
                                            class="form-control">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        {!! Form::select('id_merchant', $merchant, old('id_merchant', $promoCollection->id_merchant), [
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="date" name="promo_collection_start"
                                            value="{{ old('promo_collection_start', $promoCollection->start) }}"
                                            class="form-control">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="date" name="promo_collection_end"
                                            value="{{ old('promo_collection_end', $promoCollection->end) }}"
                                            class="form-control">
                                        ...
                                        <select name="onepoint_produk_id[]" data-control="select2"
                                            ...
                                            @foreach ($onepointProducts as $product)
                                                <option value="{{ $product->id }}"
                                                    {{ in_array($product->id, $promoProducts->pluck('onepoint_produk_id')->toArray()) ? 'selected' : '' }}>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="promo_product_name"
                                            value="{{ old('promo_product_name', $promoProducts->first()->name ?? '') }}"
                                            class="form-control">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="promo_product_diskon"
                                            value="{{ old('promo_product_diskon', $promoProducts->first()->value_diskon ?? '') }}"
                                            class="form-control">
