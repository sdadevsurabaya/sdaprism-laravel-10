                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <li class="breadcrumb-item text-muted">Merchant</li>
                            </ul>
                        </div>
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                          
                            <a class="btn btn-sm btn-primary" href="{{ route('onepoint_merchant.create')}}">Create</a>
    ...
    <script>
        ...
        $(document).ready(function() {
          ...
          function getMenuItems(row) {
            ...
            var formEdit = "{{ route('onepoint_merchant.edit', ['onepoint_merchant' => 'id_merchant']) }}";
            formEdit = formEdit.replace('id_merchant', row.id);
            menuHtml += `
        ...
        function actions(id) {
            ...
            Swal.fire({
                ...
                if (e.value === true) {
                    $.ajax({
                        url: "{{ url('') }}/merchant-delete/" + id, // Update the URL according to your route
                        method: 'POST',
                        headers: {
                        ...
                        success: function(data) {
                            ...
                            window.location.href = "{{url('onepoint_merchant')}}";
                        }
                    });
                } else {
                    e.dismiss;
