    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="../../demo1/dist/index.html" class="d-lg-none">
                <img alt="Logo" src="{{ url('template') }}/assets/media/logos/default-small.svg" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        class="menu-item menu-lg-down-accordion me-0 me-lg-2 d-none">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                                ...
                                <div class="tab-content py-4 py-lg-8 px-lg-7">
                                    ...
                                    <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-4">
                                                <img src="{{ url('template') }}/assets/media/stock/600x600/img-82.jpg"
                                    ...
                                    <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                                <img src="{{ url('template') }}/assets/media/stock/900x600/46.jpg"
                                                    class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                    ...
                                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 pe-lg-5">
                                                <img src="{{ url('template') }}/assets/media/stock/600x600/img-84.jpg"
                                                    class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                    ...
                                    <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-8">
                                                <img src="{{ url('template') }}/assets/media/stock/900x600/44.jpg"
                                                    class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                    ...
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 d-none">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            ...
                            <div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
                                        <img src="{{ url('template') }}/assets/media/stock/900x600/45.jpg"
                                            class="rounded mw-100" alt="" />
                                    </div>
                                    <!--end:Col-->
                                </div>
            ...
            <div class="app-navbar flex-shrink-0">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ url('template') }}/assets/media/avatars/300-6.jpg"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ url('template') }}/assets/media/avatars/300-2.jpg"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ url('template') }}/assets/media/avatars/300-9.jpg"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ url('template') }}/assets/media/avatars/300-14.jpg"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ url('template') }}/assets/media/avatars/300-11.jpg"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ url('template') }}/assets/media/svg/brand-logos/volicity-9.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ url('template') }}/assets/media/svg/brand-logos/tvit.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ url('template') }}/assets/media/svg/misc/infography.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ url('template') }}/assets/media/svg/brand-logos/leaf.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ url('template') }}/assets/media/svg/brand-logos/tower.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="{{ url('template') }}/assets/media/illustrations/sketchy-1/1.png" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="app-navbar-item ms-1 ms-md-3 d-none">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative d-none"
                ...
                <div class="app-navbar-item ms-1 ms-md-3 d-none">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-100 w-sm-350px" data-kt-menu="true">
                        ...
                        <div class="card">
                            ...
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <div class="card-body py-5 d-none">
                                <!--begin::Scroll-->
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                ...
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/amazon.svg"
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/angular-icon-1.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/atica.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/beats-electronics.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/codeigniter.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/bootstrap-4.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/google-tag-manager.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/disqus.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/dribbble-icon-1.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/google-play-store.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/google-podcasts.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/figma-1.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/github.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/gitlab.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/instagram-2-1.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                <img src="{{ url('template') }}/assets/media/svg/brand-logos/pinterest-p.svg"
                                                    class="w-25px h-25px mb-2" alt="" />
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                        ...
                        data-kt-menu-placement="bottom-end">
                        @if (!Auth::user())
                            <img src="{{ url('images/users/user.png') }}" alt="user" />
                        @else
                            @if (Auth::user()->image == '')
                                <img src="{{ url('images/users/user.png') }}" alt="user" />
                            @else
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ !empty(Auth::user()->image) ? url('images/users/' . Str::ucfirst(Auth::user()->image)) : url('images/users/user.png') }}" />
                                ...
                                <span class="menu-title position-relative">Language
                                    <span
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="{{ url('template') }}/assets/media/flags/united-states.svg"
                                            alt="" /></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ url('template') }}/assets/media/flags/spain.svg"
                                                alt="" />
                                        </span>Spanish</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ url('template') }}/assets/media/flags/germany.svg"
                                                alt="" />
                                        </span>German</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ url('template') }}/assets/media/flags/japan.svg"
                                                alt="" />
                                        </span>Japanese</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ url('template') }}/assets/media/flags/france.svg"
                                                alt="" />
                                        </span>French</a>
                                </div>
                                <!--end::Menu item-->
