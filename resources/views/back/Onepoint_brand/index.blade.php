                ...
                <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <a class="btn btn-sm btn-primary" href="{{ route('onepoint_brand.create') }}">Create</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table id="brand-table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-w-125px sorting">Merchant</th>
        ...
        <script>
            $(document).ready(function() {
                $('#brand-table').DataTable({
                    ajax: {
                        url: '{{ route('brand.table') }}', // Update the URL according to your route
                        type: 'GET',
                    },
                    columns: [{
                            data: null,
                        ...
                        },
                        {
                            data: null,
                            render: function(data, type, row, meta) {
                                if (row.merchant && row.merchant.length > 0) {
                                    return "Tidak Ada";
                                } else {
            ...
            function getMenuItems(row) {
                ...
                var formEdit = "{{ route('onepoint_brand.edit', ['onepoint_brand' => 'id_brand']) }}";
                formEdit = formEdit.replace('id_brand', row.id);
                menuHtml += `
                    ...
                    if (e.value === true) {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                window.location.href = "{{ url('onepoint_brand') }}";
                            }
                        });
                    } else {
                        e.dismiss;
