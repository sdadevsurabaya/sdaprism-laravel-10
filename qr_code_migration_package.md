# AGENT INSTRUCTION: QR Code Scan Multi-Feature Implementation

**OBJECTIVE**: Implement a complete QR Code scanning and API proxy feature in this Laravel project.
...
```env
RAKITAN_QR_ENDPOINT=https://bridge.tokosda.com/api-v2/endpoints/rakitan_qr.php
```
...
### File: `app/Http/Controllers/Back/ScanController.php`
```php
<?php
...
### File: `app/Http/Controllers/Back/RakitanApiController.php`
```php
<?php
...
### File: `resources/views/back/scan/index.blade.php`
*Note: This view includes the script logic and requires Bootstrap 5 + Boxicons in the layout.*
```blade
                            ...
                            <div class="card border-success shadow-none mb-3 overflow-hidden">
                                ...
                                <div class="card-body p-0">
                                    <table class="table table-sm table-borderless mb-0">
                                        <tbody>
                                            <tr class="border-bottom">
                                                <th class="ps-3 py-2 text-muted fw-normal">ID Rakitan</th>
                                    ...
                                    <div class="p-3 border-top bg-light bg-opacity-10">
                                        <div class="py-1 text-muted small">Spesifikasi:</div>
                                        <div class="fw-bold text-dark lh-base" id="res-spesifikasi">-</div>
                                    </div>
                                </div>
                            </div>
...
### File: `routes/web.php`
Add the following routes. Ensure they are within an `auth` middleware group if needed.
```php
...
## STEP 5: Add Layout Dependencies (If missing)

### File: `resources/views/back/layouts/layout.blade.php` (or equivalent)
...
1. Verify the project root is correct.
2. Create directories `app/Http/Controllers/Back` and `resources/views/back/scan` if they do not exist.
3. Write files as specified in the paths above.
4. Update `web.php` and `.env`.
5. Test the `/back/scan-qr` route.
